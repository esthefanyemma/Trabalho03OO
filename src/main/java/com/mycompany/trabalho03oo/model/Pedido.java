...
public class Pedido {
    ...
    public void setModalidadeEntrega(ModalidadeEntrega modalidadeEntrega) { 
        ...
        // Ajustar taxa de entrega baseada na modalidade
        if (modalidadeEntrega == ModalidadeEntrega.ENTREGA_DOMICILIO) {
            this.taxaEntrega = 5.0; // taxa padrão de entrega
        } else {
            this.taxaEntrega = 0.0;
        }
        calcularValorTotal();
    ...
    public void calcularTotal() {
        calcularValorTotal(); // alias para compatibilidade
    }
