...
/**
 * DAO para persistência de franquias em arquivo
 * @author 84398
 */
public class FranquiaDAO implements GenericDAO<Franquia> {
    ...
    public void salvar(Franquia franquia) throws Exception {
        ...
        // Verifica se já existe uma franquia com o mesmo ID
    ...
    private Franquia parsearLinha(String linha) {
        ...
        // Parse vendedores IDs - pode estar no campo 12 ou 13 dependendo do formato
        int vendedoresIndex = -1;
        for (int i = 12; i < campos.length; i++) {
            // Procura um campo que não seja um número decimal (ticket médio)
