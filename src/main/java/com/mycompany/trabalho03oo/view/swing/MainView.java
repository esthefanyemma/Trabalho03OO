...
import com.mycompany.trabalho03oo.controller.AutenticacaoController;
...
/**
 * Tela principal do sistema usando Swing
 * @author 84398
 */
public class MainView extends JFrame {
    ...
    // Métodos para mostrar diferentes telas (implementaremos as principais)
    ...
    public void mostrarCadastroFranquia() {
        ...
        // Atualizar a lista se algo foi cadastrado
            ...
            if (selecao != null) {
                ...
                if (franquia != null) {
                    ...
                    if (confirm == JOptionPane.YES_OPTION) {
                        ...
                        // Atualizar a lista se estivermos visualizando
                        mostrarListaFranquias();
                    }
                }
            }
    ...
    public void mostrarEdicaoFranquia(int franquiaId) {
        try {
            ...
            if (franquia != null) {
                ...
                // Atualizar a lista se algo foi editado
    ...
    private void mostrarRemocaoGerente() {
        try {
            ...
            if (selecao != null) {
                ...
                if (gerente != null) {
                    // Verificar se o gerente tem franquia associada
