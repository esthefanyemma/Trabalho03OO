...
/**
 * Testes unitários para a classe Usuario e suas subclasses
 * @author 84398
 */
...
class UsuarioTest {
    ...
    class UsuarioBaseTest {
        ...
        void testConstrutor_ComParametrosCompletos_DeveCriarUsuario() {
            // Usando Dono como implementação concreta de Usuario
        ...
        void testEquals_DeveCompararPorId() {
            ...
            // Objetos com IDs diferentes
            assertFalse(usuario1.equals(usuario2));
            
            // Objetos com mesmo ID
    ...
    class DonoTest {
        ...
        void testHeranca_DeveHerdarComportamentos() {
            ...
            // Deve ter ID definido
            assertEquals(1, dono.getId());
            
            // Deve permitir alterações
    ...
    class ComportamentosEspeciais {
        ...
        void testSetters_ComValoresNulos() {
            ...
            // Deve permitir null (validação é feita em camadas superiores)
            assertDoesNotThrow(() -> {
