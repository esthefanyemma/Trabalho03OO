...
class EnderecoTest {
    ...
    class ComportamentosEspeciais {
        ...
        void testToString_SemComplemento() {
            ...
            // Verifica que o complemento realmente é null
            assertNull(enderecoSemComplemento.getComplemento());
            
            // Verifica que os outros campos estão corretos
        ...
        void testToString_ComplementoVazio() {
            ...
            // Verifica que o complemento está vazio através do getter
            assertEquals("", endereco.getComplemento());
            
            // ToString deve ser consistente e não null
            assertNotNull(resultado);
            assertFalse(resultado.trim().isEmpty());
            
            // Teste de idempotência - toString deve retornar o mesmo resultado
        ...
        void testToString_ComplementoComEspacos() {
            ...
            // Verifica que o complemento contém apenas espaços
            assertEquals("   ", endereco.getComplemento());
